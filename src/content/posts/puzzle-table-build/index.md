---
title: Building a puzzle table, of sorts
slug: building-a-puzzle-table
date: 2026-06-10
type: blog
summary: A new build is taking shape in the form of a round end table, that is also 2 end tables.
...
![Two reclaimed wood slabs lie side by side on a dark hardwood floor beside beige carpet, with white chalk lines marking possible curved cuts. The slabs show rough live edges, knots, and weathered grain in honey and brown tones, suggesting early layout work before cutting. In the background, small hand tools and a red magazine are visible, with the readable text LIVES on the cover. The wider environment appears to be a home workshop or work area, and the tone feels practical and optimistic.](./images/cover.jpeg)
...
![Video of building a mold for an epoxy pour, showing the process of shaping flexible vinyl garden edging into a circular form. The video captures the hands-on work of cutting, bending, and securing the edging to create a sturdy mold that will hold the epoxy in place during curing. The environment appears to be a workshop with tools and materials visible in the background, and the tone is focused and methodical as the craftsman carefully constructs the mold.](./images/mold-build.mov)
...
![leaky mold](./images/bad-pour.mov)
...
![newly de-molded table halves](./images/rough-table.jpeg)

It looks like a single table, just as I had planned, but the two halves separate into distinct tables.

![the same table, split into its two halves](./images/two-tables.jpeg)
